    ...
    public void run() {
        ...
        try {
            ...
            while (true) {
                ...
                System.out.println("Total de tiros: " + sj.getCuantos());
                System.out.println("Promedio: " + sj.promedio());
                System.out.println("Desv. Est.: " + sj.stdDev());
                System.out.println("Registros extra: " + sj.getRegistrosExtra());
                
                sj.reiniciaManteniendoJugadores();
